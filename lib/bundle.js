...
/***/ function(module, exports, __webpack_require__) {
	...
	var Turtle = __webpack_require__(2);
	var Editor = __webpack_require__(3);
	var Actions = __webpack_require__(162);
	var flower_1 = __webpack_require__(163);
	var EMPTY = {
	    "type": "Sequence",
	    "statements": []
	};
	...
	function load(json) {
	    ...
	    onChange = function () { return Editor.render(editor, program, runner); };
	...
	function stepCompactingSequences() {
	    if (runner.finished()) {
	        init();
	    }
	    var result;
...
/***/ function(module, exports) {
	...
	var Statement = (function () {
	    ...
	    Statement.prototype.add = function (child) {
	        child.parent = this;
	    ...
	    Statement.prototype.detach = function () {
	        this.parent.remove(this);
	    };
	    Statement.prototype.fireChange = function () {
	    ...
	    Statement.prototype.reset = function () {
	        this.children.forEach(function (c) { return c.reset(); });
	    };
	    return Statement;
	}());
	...
	var Forward = (function (_super) {
	    ...
	    Forward.prototype.execute = function (canvas) {
	...
	var Turn = (function (_super) {
	    ...
	    Turn.prototype.execute = function (canvas) {
	...
	var Sequence = (function (_super) {
	    ...
	    Sequence.prototype.execute = function (canvas) {
	...
	var Repeat = (function (_super) {
	    ...
	    Repeat.prototype.execute = function (canvas) {
	...
	var ForwardIO = (function () {
	    function ForwardIO() {
	    }
	    ForwardIO.prototype.read = function (json) {
	        var forward = new Forward();
	        forward.amount = json.amount;
	        return forward;
	    };
	    ForwardIO.prototype.write = function (stmt) {
	        return {
	            type: "Forward",
	            amount: stmt.amount
	        };
	...
	exports.ForwardIO = ForwardIO;
	var TurnIO = (function () {
	    function TurnIO() {
	    }
	    TurnIO.prototype.read = function (json) {
	        var turn = new Turn();
	        turn.angle = json.angle;
	        return turn;
	    };
	    TurnIO.prototype.write = function (stmt) {
	        return {
	            type: "Turn",
	            angle: stmt.angle
	        };
	...
	exports.TurnIO = TurnIO;
	var RepeatIO = (function () {
	    function RepeatIO() {
	    }
	    RepeatIO.prototype.read = function (json) {
	        var repeat = new Repeat();
	        repeat.times = json.times;
	        repeat.add(exports.readStatement(json.statement));
	        return repeat;
	    };
	    RepeatIO.prototype.write = function (stmt) {
	        return {
	            type: "Repeat",
	            times: stmt.times,
	            statement: exports.writeStatement(stmt.children[0])
	        };
	    };
	    return RepeatIO;
	}());
	exports.RepeatIO = RepeatIO;
	var SequenceIO = (function () {
	    function SequenceIO() {
	    }
	    SequenceIO.prototype.read = function (json) {
	        var sequence = new Sequence();
	        json.statements.forEach(function (jsonStmt) { return sequence.add(exports.readStatement(jsonStmt)); });
	        return sequence;
	    };
	    SequenceIO.prototype.write = function (stmt) {
	        return {
	            type: "Sequence",
	            statements: stmt.children.map(function (stmt) { return exports.writeStatement(stmt); })
	        };
	    };
	    return SequenceIO;
	}());
	exports.SequenceIO = SequenceIO;
	/**
	...
	exports.readStatement = function (json) {
	    var statementType = exports.STATEMENT_TYPES[json.type];
	    if (statementType === undefined) {
	        throw new Error("unknown statement type " + json.type);
	    }
	    return statementType.read(json);
	};
	exports.writeStatement = function (stmt) {
	    var statementType = exports.STATEMENT_TYPES[name(stmt)];
	    if (statementType === undefined) {
...
/***/ function(module, exports) {
	...
	"use strict";
	var Turtle = (function () {
	    function Turtle(l, position) {
	        this.l = l;
	        this.position = position;
	        this.penDown = true;
	        this.direction = 180;
	    }
	    Turtle.prototype.forward = function (amount) {
	    ...
	    Turtle.prototype.turn = function (angle) {
	        var previousAngle = this.direction;
	        this.direction += angle;
	        this.direction = this.direction % 360;
	        this.l.turtleTurned(previousAngle);
	    };
	    Turtle.DEG2RAD = 2 * Math.PI / 360;
	    return Turtle;
	}());
	exports.Turtle = Turtle;
	var TurtleCanvas = (function () {
	    function TurtleCanvas(trailsCanvas, turtleCanvas, scale) {
	        this.scale = scale;
	    ...
	    TurtleCanvas.prototype.line = function (p0, p1) {
	    ...
	    TurtleCanvas.prototype.drawTurtle = function (previousPosition) {
	        this.turtleContext.clearRect((previousPosition.x) * this.scale - TurtleCanvas.TURTLE_SIZE / 2.0 - 1, (previousPosition.y) * this.scale - TurtleCanvas.TURTLE_SIZE / 2.0 - 1, TurtleCanvas.TURTLE_SIZE + 2, TurtleCanvas.TURTLE_SIZE + 2);
	        var startAngle = (360 - this.turtle.direction) % 360;
	        var endAngle = (180 - this.turtle.direction) % 360;
	        this.turtleContext.beginPath();
	        this.turtleContext.arc(this.turtle.position.x * this.scale, this.turtle.position.y * this.scale, TurtleCanvas.TURTLE_SIZE / 2.0, startAngle * Turtle.DEG2RAD, endAngle * Turtle.DEG2RAD);
	        this.turtleContext.fill();
	    };
	    TurtleCanvas.prototype.turtleMoved = function (previousPosition) {
	        this.line(previousPosition, this.turtle.position);
	        this.drawTurtle(previousPosition);
	    };
	    TurtleCanvas.prototype.turtleTurned = function (previousAngle) {
	        this.drawTurtle(this.turtle.position);
	    };
	    TurtleCanvas.initContext = function (canvas) {
	    ...
	    TurtleCanvas.TURTLE_SIZE = 24;
	    return TurtleCanvas;
	}());
	exports.TurtleCanvas = TurtleCanvas;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Program = __webpack_require__(1);
	function render(slot, program, runner) {
	    ReactDom.render(createWidget(program, runner), slot);
	}
	exports.render = render;
	function createWidget(stmt, runner) {
	    if (stmt instanceof Program.Forward) {
	        return React.createElement(Forward, {statement: stmt, runner: runner});
	    }
	    else if (stmt instanceof Program.Turn) {
	        return React.createElement(Turn, {statement: stmt, runner: runner});
	    }
	    else if (stmt instanceof Program.Repeat) {
	        return React.createElement(Repeat, {statement: stmt, runner: runner});
	    }
	    else if (stmt instanceof Program.Sequence) {
	        return React.createElement(Sequence, {statement: stmt, runner: runner});
	    }
	    return null;
	}
	var Forward = (function (_super) {
	    ...
	    Forward.prototype.render = function () {
	        return React.createElement("li", null, "Forward", React.createElement(NumberInput, React.__spread({}, new PropertyAccessor(this.props.statement, "amount"))), "steps", React.createElement(Remove, {statement: this.props.statement}), React.createElement(CurrentMarker, {statement: this.props.statement, runner: this.props.runner}));
	    };
	    Forward.prototype.onChange = function (e) {
	        var value = e.target.value;
	        this.setState({
	            value: value
	        });
	    };
	    Forward.prototype.onBlur = function (e) {
	...
	var Turn = (function (_super) {
	    ...
	    Turn.prototype.render = function () {
	        return React.createElement("li", null, "Turn", React.createElement(NumberInput, React.__spread({}, new PropertyAccessor(this.props.statement, "angle"))), "degrees", React.createElement(Remove, {statement: this.props.statement}), React.createElement(CurrentMarker, {statement: this.props.statement, runner: this.props.runner}));
	    };
	    return Turn;
	}(React.Component));
	var Sequence = (function (_super) {
	    ...
	    Sequence.prototype.render = function () {
	        var _this = this;
	        var statemenst = this.props.statement.children.map(function (c, i) {
	            return createWidget(c, _this.props.runner);
	        });
	        return React.createElement("div", null, React.createElement("button", {type: "button", onClick: function () { return _this.onAdd(); }, disabled: this.isAdding()}, "add"), React.createElement("ul", null, statemenst, this.newStatement()));
	    };
	    ...
	    Sequence.prototype.isAdding = function () {
	        return this.state.newStatement !== undefined;
	    };
	    Sequence.prototype.newStatement = function () {
	        var _this = this;
	        if (!this.isAdding()) {
	            return null;
	        }
	        var options = [React.createElement("option", null)];
	        for (var key in Program.STATEMENT_TYPES) {
	            if (key !== "Sequence") {
	                options.push(React.createElement("option", {value: key}, key));
	            }
	        }
	        return React.createElement("li", null, React.createElement("select", {onChange: function (e) { return _this.onSelectNewStatement(e); }}, options));
	    };
	    Sequence.prototype.onSelectNewStatement = function (e) {
	...
	var Repeat = (function (_super) {
	    ...
	    Repeat.prototype.render = function () {
	        var statement = this.props.statement.children.length > 0
	            ? createWidget(this.props.statement.children[0], this.props.runner)
	            : null;
	        return React.createElement("li", null, "Repeat", React.createElement(NumberInput, React.__spread({}, new PropertyAccessor(this.props.statement, "times"))), "times", React.createElement(Remove, {statement: this.props.statement}), React.createElement(CurrentMarker, {statement: this.props.statement, runner: this.props.runner}), statement);
	    };
	    return Repeat;
	}(React.Component));
	var PropertyAccessor = (function () {
	    function PropertyAccessor(object, property) {
	        var _this = this;
	        this.object = object;
	        this.property = property;
	        this.get = function () { return _this.object[_this.property]; };
	        this.set = function (value) {
	            _this.object[_this.property] = value;
	        };
	    }
	...
	var NumberInput = (function (_super) {
	    ...
	    NumberInput.prototype.render = function () {
	        var _this = this;
	        return React.createElement("input", {type: "number", value: this.state.value, onChange: function (e) { return _this.onChange(e); }, onBlur: function (e) { return _this.onBlur(e); }});
	    };
	    ...
	    NumberInput.prototype.onBlur = function (e) {
	        var n = new Number(this.state.value).valueOf();
	        if (n >= 1 && n <= 1000) {
	            this.props.set(n);
	        }
	        else {
	...
	var Remove = (function (_super) {
	    ...
	    Remove.prototype.render = function () {
	        var _this = this;
	        return React.createElement("button", {type: "button", onClick: function () { return _this.onClick(); }}, "remove");
	    };
	    Remove.prototype.onClick = function () {
	...
	var CurrentMarker = (function (_super) {
	    __extends(CurrentMarker, _super);
	    function CurrentMarker() {
	        _super.apply(this, arguments);
	    }
	    CurrentMarker.prototype.render = function () {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var React = __webpack_require__(4);
	var ReactDom = __webpack_require__(161);
	function render(slot, listeners) {
	    ReactDom.render(React.createElement(Actions, {listeners: listeners}), slot);
	}
	exports.render = render;
	var Actions = (function (_super) {
	    ...
	    Actions.prototype.render = function () {
	        var _this = this;
	        return React.createElement("div", null, React.createElement("button", {type: "button", onClick: function () { return _this.props.listeners.onRun(); }}, "run"), React.createElement("button", {type: "button", onClick: function () { return _this.props.listeners.onStop(); }}, "stop"), React.createElement("button", {type: "button", onClick: function () { return _this.props.listeners.onStep(); }}, "step"), React.createElement("input", {type: "file", onChange: function (e) { return _this.handleFile(e); }}), React.createElement("button", {type: "button", onClick: function () { return _this.download(); }}, "save"));
	    };
	    Actions.prototype.handleFile = function (e) {
	        var _this = this;
	        var reader = new FileReader();
	        var target = e.target;
	        var file = target.files[0];
	        reader.onload = function (upload) {
	            _this.props.listeners.onLoad(upload.target.result);
	        };
	        reader.readAsText(file);
	    };
	    Actions.prototype.download = function () {
	        var filename = "smiley.json";
	        var text = this.props.listeners.onSave();
